...
\end{itemize}
\begin{center}
\includegraphics[height=0.9\textheight]{\string"Use_cases_and_Sequence_diagram/SequenceDiagrams svg/svg/StateMachine3__User_23\string".eps} 
\par\end{center}
...
\end{itemize}
\begin{center}
\includegraphics[height=0.9\textheight]{\string"Use_cases_and_Sequence_diagram/SequenceDiagrams svg/svg/StateMachine1__Queue Manager _21\string".eps}
\par\end{center}
